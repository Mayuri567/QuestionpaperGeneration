          ...
          <div class="vd_content-section clearfix">
            <div class="vd_login-page">
              <div class="heading clearfix">
                ...
                <h2 class="text-center font-semibold vd_grey">FACULTY   LOGIN </h2>
              </div>
              <div class="panel widget">
                <div class="panel-body">
                <div class="login-icon entypo-icon"> <i class="icon-key"></i> </div>
                  <form class="form-horizontal" id="login-form" method="post" action="/checkfaculty">
                  @csrf
                  <div>
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <center><div class=""> <a href="/adminlogin"><font size="4px">I AM ADMIN </font></a> </div></center>
                        </div>
                      </div>
                    </div>
                  </form>
