      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
            ...
            <div class="vd_register-page">
              ...
              <div class="heading clearfix">
                ...
                <h4 class="text-center font-semibold vd_grey">ADD DEPARTMENT HERE</h4>
              </div>
              <br><br>
...
<!--                  <div id="register-success" class="alert alert-success" style="display:none;"><i class="fa fa-exclamation-circle fa-fw"></i> Registration confirmation has been sent to your email </div>
                  ...
                  <form class="form-horizontal"  action="depart" role="form" id="register-form" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="alert alert-danger vd_hidden">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                    <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh no!</strong> Enter Data Properly </div>
                  ...
                  <!-- <div class="alert alert-success vd_hidden">
                    ...
                    <div class="form-group">
                      <div class="col-md-12">
                        <div class="label-wrapper">
                          <label class="control-label">Departmet Name <span class="vd_red">*</span></label>
                        </div>
                        <div class="vd_input-wrapper" id="email-input-wrapper"> <span class="menu-icon"> <i class="fa fa-institution "></i> </span>
                          <input type="text" placeholder="Department Name..." class="required" required  name="departmentname" id="departmentname">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-12">
                        <div class="label-wrapper">
                          <label class="control-label"> University <span class="vd_red">*</span></label>
                        </div>
                        <!-- <div class="vd_input-wrapper" id="email-input-wrapper"> <span class="menu-icon"> <i class="fa fa-institution "></i> </span>
                          <input type="email" placeholder="Department Name..." class="required" required  name="departmentname" id="departmentname">
                        </div> -->
                        <select name="university">
                            <option value="">Select Your University</option>
                            @foreach($uni as $data)
                            <option value="{{$data->university_id}}">{{$data->university_name}}</option>
                            @endforeach
                          </select>
                      </div>
                      @error('university')
                    ...
                    <div class="form-group">
                      <div class="col-md-12">
                        ...
                        <div class="vd_input-wrapper" id="email-input-wrapper"> <span class="menu-icon"> <i class="icon-house "></i> </span>
                          <input type="text" placeholder="City Name..." class="required" required  name="city" id="city">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <div class="label-wrapper">
                        <label class="control-label">Upload Your Photo <span class="vd_red">*</span></label>
                        </div>
                        <div class="vd_input-wrapper" id="image-input-wrapper"> <span class="menu-icon"> <i class="glyphicon glyphicon-camera"></i> </span>
                          <input type="file" placeholder="Photo" class="required" required  name="image" id="image">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="vd_input-wrapper" id="last-name-input-wrapper"> <span class="menu-icon"> <i class="fa fa-institution"></i> </span>
                          <input type="text" placeholder="Designation.." class="required" required name="designation" id="designation">
                        </div>
                      </div>
