              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Question Paper </h3>
                  </div>
                  ...
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables">
                      ...
                      @foreach($question as $e)
                        <tr>
                          <td>{{$e->questionpaper_id}}</td>
                          <td>{{$e->exam_code}}</td>
                          @if($e->difficulty_level=='easy')
                        <td><span class="label label-success">{{$e->difficulty_level}}</span></td>
                        
                        @elseif($e->difficulty_level=='medium')
                        <td><span class="label label-warning">{{$e->difficulty_level}}</span></td>
                        
                        @elseif($e->difficulty_level=='hard')
                        <td><span class="label label-danger">{{$e->difficulty_level}}</span></td>
                        @endif
                        ...
                        <td>{{$e->date}}</td>
                          ...
                          <a href="pdf/{{$e->questionpaper_id}}" target="_blank">Generate PDF</a>
                          </td>
