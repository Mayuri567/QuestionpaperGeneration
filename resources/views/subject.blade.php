...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <div class="form-group">
    <label for="exampleInputID">Subject ID</label>
    <input type="text" class="form-control" id="subjectid" name="subjectid" aria-describedby="emailHelp" disabled>
  ...
  <div class="form-group">
    ...
    <select name="course">
                            ...
                            @foreach($cou as $st)
                            <option value="{{$st->course_id}}">{{$st->course_name}}</option>
                            @endforeach
                          </select>
  </div>
  <div class="form-group">
  ...
  <select name="semester">
    ...
    <option value="8">8</option>
      ...
      <div class="modal-footer bg-success">
        ...
        <button type="submit" id="submitsubject" class="btn btn-primary">Save Data</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="coursemodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <center><h5 class="modal-title " id="exampleModalLongTitle">ADD SUBJECT</h5></center>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
  ...
  <div class="form-group">
    ...
    <select name="course">
                            <option value="">Select Your Course</option>
                            @foreach($cou as $data)
                            <option value="{{$data->course_id}}"><div id="opt">{{$data->course_name}}</div></option>
                            @endforeach
                          </select>
    <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
  </div>
...
$('#submitsubject').on('click',function(e){
    e.preventDefault();
    
    var edit_id=$('#subjectid').val();

    $.ajax({
      type: "PUT",
      url: "/editsubject/"+edit_id,
