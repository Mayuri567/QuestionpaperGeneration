...
<!-- Mirrored from www.venmond.com/demo/vendroid/pages-login.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Apr 2020 05:28:23 GMT -->
          ...
          <div class="vd_content-section clearfix">
            <div class="vd_login-page">
              <div class="heading clearfix">
                ...
                <h2 class="text-center font-semibold vd_grey">ADMIN   LOGIN </h2>
              </div>
              <div class="panel widget">
                <div class="panel-body">
                  <div class="login-icon entypo-icon"> <i class="icon-user"></i> </div>
                  <form class="form-horizontal" id="login-form" method="post" action="/admincheck">
                  @csrf
                  <div>
                      <p id="error">
                      {{Session::get('data')}}
                  ...
                  <!-- <div class="alert alert-danger vd_hidden">
                    ...
                    <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> {{Session::get('data')}} </div> -->
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <center><div class=""> <a href="/"><font size="4px">I AM FACULTY </font></a> </div></center>
                        </div>
                      </div>
                    </div>
                  </form>
