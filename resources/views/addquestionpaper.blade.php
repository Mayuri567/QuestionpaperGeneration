...
<!-- Head menu search form ends -->                         
  ...
  <div class="container">
	...
	<div class="navbar-menu clearfix">
    	...
    	<h3 class="menu-title hide-nav-medium hide-nav-small">Faculty</h3>
        <div class="vd_menu">
        	 <ul>
    <li>
    	<a href="faculty">
      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
            ...
            <div class="vd_register-page">
              ...
              <div class="heading clearfix">
                ...
                <h4 class="text-center font-semibold vd_grey"> Question Paper</h4>
              </div>
              <br><br>
...
<!--                  <div id="register-success" class="alert alert-success" style="display:none;"><i class="fa fa-exclamation-circle fa-fw"></i> Registration confirmation has been sent to your email </div>
                  ...
                  <form class="form-horizontal"  action="/savequestionpaper" traget="blank_" role="form" id="register-form" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      <div class="col-md-6">
                        ...
                        <div class="vd_input-wrapper" id="first-name-input-wrapper"> <span class="menu-icon"> 
                        </span>
                        <select name="subject">
                      ...
                      <div class="col-md-6">
                        <div class="label-wrapper">
                          <label class="control-label">Exam Code <span class="vd_red">*</span></label>
                        </div>
                        <div class="vd_input-wrapper" id="first-name-input-wrapper"> <span class="menu-icon"> 
                        <i class=" icon-book"></i> 
                        </span>
                          <input type="text" placeholder="SUB001" class="required" name="examcode" required id="examcode">
                        </div>
                      </div>    
                  ...
                  <div class="form-group">
                      <div class="col-md-6">
                        <div class="label-wrapper">
                          <label class="control-label"> Difficulty Level <span class="vd_red">*</span></label>
                        </div>
                        <div class="vd_input-wrapper" id="first-name-input-wrapper"> <span class="menu-icon"> 
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" placeholder="Date" name="date" id="datepicker-icon">
                      ...
                      <div class="col-md-12">
                        <div class="label-wrapper">
                          <label class="control-label"> Mark Per Module <span class="vd_red">*</span></label>
                        </div>
                        <div class="vd_input-wrapper" id="first-name-input-wrapper"><span class="menu-icon"> <i class="fa fa-question"></i> </span>
                          <input type="number" placeholder="Marks Per Module..." class="required" required name="markspm" id="markspm"> 
                        </div>
                      </div>
                     </div>
                  ...
                  <div class="form-group">
                      <div class="col-md-6">
                        <div class="label-wrapper">
                          <label class="control-label"> No. Of. Module <span class="vd_red">*</span></label>
                        </div>
                        <div class="vd_input-wrapper" id="first-name-input-wrapper"> <span class="menu-icon"> 
                        <!-- <i class="fa fa-user"></i>  -->
                        </span>
                        <select name="module">
                            <option value="">Select No. Of. Module</option>
                      ...
                      <div class="col-md-6">
                        <div class="label-wrapper">
                          <label class="control-label"> Questions Per Module <span class="vd_red">*</span></label>
                        </div>
                        <!-- <div class="input-group"> -->
                        <select name="questionpm">
                            <option value="">Questions Per Module</option>
                            <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
                      ...
                      <div class="col-md-6">
                        <div class="label-wrapper">
                          <label class="control-label"> Time Of Exam <span class="vd_red">*</span></label>
                        </div>
                        <div class="vd_input-wrapper" id="first-name-input-wrapper"> <span class="menu-icon"> 
                        <i class="glyphicon glyphicon-time"></i> 
                        </span>
                          <input type="text" placeholder="Enter Exam Time in Hours" class="required" required name="time" id="time">
                        </div>
                      </div>

                      <div class="col-md-6">
                        <div class="label-wrapper">
                          <label class="control-label"> Option Per Module <span class="vd_red">*</span></label>
                        </div>
                        <select name="option">
                            <option value="">Options Per Module</option>
                            <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                        </select>
                      ...
                      <div class="col-md-12 text-center mgbt-xs-5">
                        <button class="btn vd_bg-green vd_white width-100" type="submit" id="submit-register" name="submit-register">ADD </button>
                      </div>
                    </div>
                    </div>                    
                    </div>
...
<!-- Mirrored from www.venmond.com/demo/vendroid/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Apr 2020 05:21:39 GMT -->
</html>