...
<head>
    <meta charset="utf-8" />
    <title>{{Session::get('user')}} PROFILE</title>
      ...
      <div class="vd_top-menu-wrapper">
        <div class="container ">
          ...
          <div class="vd_panel-header">
          	<div class="logo">
            	<!-- <a href="/adminpanel"><img alt="logo" src="/img/logo.png"></a> -->
            </div>
            <!-- logo -->
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="panel widget light-widget">
                  ...
                  <form class="form-horizontal" action="/checkedit/{{session('aid')}}" role="form" enctype="multipart/form-data" method="post">
                  @csrf
                      ...
                      <div class="row">
                        <div class="col-sm-3 mgbt-xs-20">
                          <div class="form-group">
                            <div class="col-xs-12">
                              <div class="form-img text-center mgbt-xs-15"> <img alt="example image" src="\adminphoto\{{session('photo')}}"> </div>
