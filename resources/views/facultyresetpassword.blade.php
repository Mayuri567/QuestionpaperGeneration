...
<!-- Mirrored from www.venmond.com/demo/vendroid/pages-forget-password.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Apr 2020 15:06:36 GMT -->
        ...
        <div class="vd_content clearfix">               
            ...
            <div class="vd_login-page">     
            	<div class="heading clearfix">
                    ...
                    <h4 class="text-center font-semibold vd_grey">RESET PASSWORD HERE</h4>                     
                </div>
                ...
                <div class="panel widget">
                    <div class="panel-body">
                          ...
                          <form class="form-horizontal" method="get"  id="forget-password-form" action="checkemail">
                  ...
                  <div class="alert alert-success vd_hidden">
                    ...
                    <span class="vd_alert-icon"><i class="fa fa-check-circle vd_green"></i></span>Your reset password form has been sent to your email. </div>                            
                             <div class="form-group mgbt-xs-20">
                                 <div class="col-md-12">
                                 	<p class="text-center"><strong>To reset your password, enter the email address you use to sign in to this System.</strong> </p>
                                    <div class="vd_input-wrapper" id="email-input-wrapper">
                                        <span class="menu-icon">
                                            <i class="fa fa-envelope"></i>
                                        </span>
                                        <input type="email" placeholder="Email" id="email" name="email" class="required" require>
                                    </div>   
                            ...
                            <div class="form-group" id="submit-password-wrapper">
                              <div class="col-md-12 text-center mgbt-xs-5">
                                  <button class="btn vd_bg-green vd_white width-100" type="submit" id="submit" name="submit">Send me my password</button>   
                              </div>
                            </div>
                          </form>        
                    </div>
                ...
                <div class="register-panel text-center font-semibold">	
                	<a href="/">LOGIN</a> <span class="mgr-10 mgl-10"></span>  	    	
                </div>
                </div> <!-- vd_login-page -->                                            
            </div>   
          <!-- .vd_content-section --> 
