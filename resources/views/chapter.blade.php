...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <center><h5 class="modal-title " id="exampleModalLongTitle">EDIT SUBJECT</h5></center>
  ...
  <div class="form-group">
    <label for="exampleInputID">Chapter ID</label>
    <input type="text" class="form-control" id="chapterid" name="chapterid" aria-describedby="emailHelp" disabled>
  </div>
  <div class="form-group">
    <label for="exampleInputName">Chapter Name</label>
  ...
  <div class="form-group">
    <label for="exampleInputName">Credit</label>
...
<div class="modal fade" id="coursemodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <center><h5 class="modal-title " id="exampleModalLongTitle">ADD CHAPTER</h5></center>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
  ...
  <div class="form-group">
    ...
    <select name="subject">
                            ...
                            @foreach($sub as $data)
                            <option value="{{$data->subject_id}}"><div id="opt">{{$data->subject_name}}</div></option>
                            @endforeach
                          </select>
  ...
  <!-- <button type="submit" class="btn btn-primary">Submit</button> -->
      ...
      <div class="modal-footer bg-success">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" id="submitchap" class="btn btn-primary">Save Data</button>
...
<!-- Head menu search form ends -->                         
  ...
  <div class="container">
    ...
    <li>
    <a href="chapter" data-action="click-trigger">
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Chapter </h3>
                  </div>
...
$(document).ready(function(){
    ...
    $tr = $(this).closest('tr');
        ...
        console.log(data);
        $('#chapterid').val(data[0]);
        $('#chaptername').val(data[1]);
        $('#subject').val(data[2]);
        $('#credit').val(data[3]);
        $('#action').val(data[4]);
...
$('#submitdepart').on('click',function(e){
    ...
    var edit_id=$('#chapterid').val();

    $.ajax({
      type: "PUT",
      url: "/editchapter/"+edit_id,
