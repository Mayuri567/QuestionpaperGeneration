...
<head>
    <meta charset="utf-8" />
    <title>{{Session::get('fname')}} PROFILE</title>
      ...
      <div class="vd_mega-menu-content  width-xs-2  left-xs left-sm" data-action="click-target">
        <div class="child-menu"> 
        	<div class="content-list content-menu">
                ...
                <li> <a href="/editadmin/{{session('fid')}}"> <div class="menu-icon"><i class=" fa fa-user"></i></div> <div class="menu-text">Edit Profile</div> </a> </li>
...
<!-- Head menu search form ends -->                         
  ...
  <div class="container">
	...
	<div class="navbar-menu clearfix">
		...
		<ul>
    <li>
    	<a href="/faculty" data-action="click-trigger">
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="panel widget light-widget">
                  ...
                  <form class="form-horizontal" action="/checkfedit/{{session('fid')}}" role="form" enctype="multipart/form-data" method="post">
                  @csrf
                    <div  class="panel-body">
                      <h2 class="mgbt-xs-20"> Profile: <span class="font-semibold">{{ $data->firstname }} {{ $data->lastname }} </span> </h2>
                      <br/>
                      <div class="row">
                        <div class="col-sm-3 mgbt-xs-20">
                          <div class="form-group">
                            <div class="col-xs-12">
                              <div class="form-img text-center mgbt-xs-15"> <img alt="example image" src="\facultyphoto\{{session('photo')}}"> </div>
                              <div class="form-img-action text-center mgbt-xs-20"> <input  type="file" name="photo"> </div>
                              <br/>
                              <div>
                        ...
                        <div class="col-sm-9">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <input type="email" name="email" value="{{ $data->email }}"  placeholder="email@yourcompany.com">
                                </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <input type="password" name="password" value="{{$data->password}}" placeholder="password">
                                </div>
                                <!-- col-xs-12 --> 
                              </div>
                              <!-- row --> 
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <input type="password" name="confirmpass" placeholder="Re-password">
                                </div>
                                <!-- col-xs-12 --> 
                              </div>
                              @error('confirmpass')
