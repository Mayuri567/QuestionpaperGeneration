...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <center><h5 class="modal-title " id="exampleModalLongTitle">EDIT DEPARTMENT</h5></center>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="departmentid" name="departmentid" aria-describedby="emailHelp" disabled>
  ...
  <div class="form-group">
    <label for="exampleInputText">University</label>
    <select name="university">
                            <option value="">Select Your University</option>
                            @foreach($uni as $vt)
                            <option value="{{$vt->university_id}}">{{$vt->university_name}}</option>
                            @endforeach
                          </select>
  </div>
  <div class="form-group">
                    ...
                    <table class="table" id="datatable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="center">{{$e->university_name}}</td>
                          <td class="center">{{$e->city}}</td>
                          <!-- <td class="center"><span class="label label-success">Active</span></td> -->
                          <td class="menu-action rounded-btn"> 
                          <button data-id="editdata" data-original-title="Edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_yellow editbtn"><i class="fa fa-pencil"></i></button>
...
$('#submitdepart').on('click',function(e){
    ...
    var edit_id=$('#departmentid').val();

    $.ajax({
      type: "PUT",
      url: "/editdepart/"+edit_id,
...
$('#condelete').on('submit',function(e){
    e.preventDefault();
     ...
     var department_id=$('#delete_id').val();

     $.ajax({
        type: "GET",
        url: "/deletedepart/"+department_id,
